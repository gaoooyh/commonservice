 ...
 */
public abstract class Captcha extends CodeRandoms {
    // 常用颜色
    ...
    public void setFont(int font, int style, float size) throws IOException, FontFormatException {
        this.font = Font.createFont(Font.TRUETYPE_FONT, new File(getClass().getResource("/static/font/" + FONT_NAMES[font]).getFile())).deriveFont(style, size);
    }
